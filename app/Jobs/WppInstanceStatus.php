...
class WppInstanceStatus implements ShouldQueue
{
    ...
    {
        $this->url = 'https://api.meusestudosead.com.br/api/' . $wpp->session . '/' . env('WPP_KEY') . '/status-session';
        $this->wpp = $wpp;
    }
    ...
    public function handle()
    {
        try {
            ...
            if ($response->getStatusCode() === 200) {
                ...
                return response()->json(['success' => 'Status'], $response->getStatusCode());
